...
const formSchema = z.object({
    name: z.string({ "required_error": "Your business name is required" }),
})


const BusinessNameForm = ({ initialData, business_id } : BusinessNameFormProps ) => {
        ...
        <section className="bg-white border-2 border-slate-100 rounded-lg p-4">
            <div className="flex flex-col">
                ...
                {isEditing  ? <>
                    ...
                    <p className="text-slate-500 text-sm mt-2">{initialData ? initialData : "No business name"}</p>
                </>}
