...
const TiktokForm = ({ initialData, business_id }: TiktokFormProps) => {
            ...
            <div className="flex flex-col">
                ...
                {isEditing ? <>
                    <Form {...form}>
                        ...
                        <p className="text-slate-500 text-sm mt-2">{initialData ? initialData : "No Tiktok link"}</p>
                </>}
