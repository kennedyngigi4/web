...
interface BusinessPhoneFormProps {
    initialData: string;
    business_id: string;
}

const formSchema = z.object({
    phone: z.string({ "required_error": "Your business phone is required" }),
})


const BusinessPhoneForm = ({ initialData, business_id } : BusinessPhoneFormProps ) => {
        ...
        <section className="bg-white border-2 border-slate-100 rounded-lg p-4">
            <div className="flex flex-col">
                ...
                {isEditing  ? <>
                    ...
                    <p className="text-slate-500 text-sm mt-2">{initialData ? initialData : "No business phone"}</p>
                </>}
...
export default BusinessPhoneForm