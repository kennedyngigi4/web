...
const YoutubeForm = ({ initialData, business_id }: YoutubeFormProps) => {
    ...
    useEffect(() => {
        if (initialData) {
            form.reset({ youtube: initialData });
        }
    }, [initialData]);
            ...
            <div className="flex flex-col">
                ...
                {isEditing ? <>
                    <Form {...form}>
                        ...
                        <p className="text-slate-500 text-sm mt-2">{initialData ? initialData : "No YouTube link"}</p>
                </>}
